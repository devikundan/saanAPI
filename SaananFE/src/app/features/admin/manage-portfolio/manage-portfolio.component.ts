    ...
    <div class="admin-page">
        ...
        <div class="admin-form-panel">
          ...
          <form [formGroup]="form" (ngSubmit)="onSubmit()">
            <div class="form-row">
              ...
              <div class="form-group"><label>Slug</label><input formControlName="slug"></div>
            </div>
            ...
            <div class="form-row">
              ...
              <div class="form-group"><label>Project URL</label><input formControlName="projectUrl"></div>
            </div>
            <div class="form-row">
              <div class="form-group"><label>Thumbnail URL</label><input formControlName="thumbnailUrl"></div>
              <div class="form-group"><label>Technologies</label><input formControlName="technologies" placeholder="React, Node.js"></div>
            </div>
            <div class="form-row">
              <div class="form-group"><label>Completed At</label><input formControlName="completedAt" type="date"></div>
      ...
      @if (isLoading()) {
        ...
        <table class="admin-table">
          <thead><tr><th>Title</th><th>Client</th><th>Order</th><th>Active</th><th>Actions</th></tr></thead>
          <tbody>
